  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-64px)] w-full max-w-md items-center px-4 py-8">
      <section className="w-full rounded-2xl border border-[var(--border)] bg-[color:var(--surface)]/80 p-6">
        <h1 className="text-2xl font-bold text-zinc-50">بازیابی رمز عبور</h1>
        <p className="mt-2 text-sm text-zinc-400">ایمیل حساب را وارد کن تا لینک بازیابی برات ارسال بشه.</p>

        {params.success ? (
          <p className="mt-4 rounded-xl bg-emerald-500/15 p-3 text-sm text-emerald-300">لینک بازیابی فرستاده شد.</p>
        ) : null}
